...
#### Numeric
  ...
  * `mean_word_length` - derived by <img src="https://latex.codecogs.com/svg.latex?\frac{\text{char\_length}}{\text{word\_count}}" title="\frac{\text{char\_length}}{\text{word\_count}}" style="background: white"/>, the average number of characters used for a word in a tweet
...
#### Sentiment Analysis
  * Lexicon: [NRC-Hashtag-Emotion-Lexicon-v0.2](https://saifmohammad.com/WebPages/NRC-Emotion-Lexicon.htm) <sup>[<a href="#reference-1">1</a>, <a href="#reference-2">2</a>]</sup>
    * score: real-valued score between 0 to <img src="https://latex.codecogs.com/svg.latex?\infty" title="\infty" style="background: white"/>
    * size: 16862 unigrams
    * emotions
...
#### Random Forest
  * Bagging
    ...
    * confusion matrix on validation set:
      ...
      <img src="https://latex.codecogs.com/svg.latex?\begin{matrix}&\text{Reference}&\\\text{Prediction}&0&1\\0&752&223\\1&115&431\end{matrix}" title="\infty" style="background: white"/>
  ...
  * Boosting
    ...
    * confusion matrix on validation set:
      ...
      <img src="https://latex.codecogs.com/svg.latex?\begin{matrix}&\text{Reference}&\\\text{Prediction}&0&1\\0&735&233\\1&132&421\end{matrix}" title="\infty" style="background: white"/>
...
#### Neural Network
  ...
  * confusion matrix on validation set:
    ...
    <img src="https://latex.codecogs.com/svg.latex?\begin{matrix}&\text{Reference}&\\\text{Prediction}&0&1\\0&716&151\\1&220&434\end{matrix}" title="\infty" style="background: white"/>
...
### Performance on Test Set Using Random Forest (Bagging)
  ...
  * confusion matrix on validation set:
    ...
    <img src="https://latex.codecogs.com/svg.latex?\begin{matrix}&\text{Reference}&\\\text{Prediction}&0&1\\0&1566&504\\1&297&896\end{matrix}" title="\infty" style="background: white"/>
