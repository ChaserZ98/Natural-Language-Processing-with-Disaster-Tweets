...
# tidy_trainset %>%
#   ggplot() +
#   geom_bar(aes(x = lengthType, color = as.factor(target)))


# tidy_trainset %>% mutate(keyword = str_replace_all(keyword, "%20", ' ')) %>%
